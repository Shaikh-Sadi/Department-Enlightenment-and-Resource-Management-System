          ...
          <nav class="navbar navbar-inverse" style= "border-redius:0px !important; margin-bottom:0px;">
               ...
               <div class="navbar-collapse collapse" >
                    <ul class="nav navbar-nav">
	                     ...
	                     <li class="dropdown">
                             <a class="dropdown-toggle" style="color:#339900;" href="www.w3school.com" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">About U<span class="caret"></span></a>
