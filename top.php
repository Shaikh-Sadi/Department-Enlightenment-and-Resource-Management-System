                        ...
                        <div class="container">
                            ...
                            <div class="navbar-collapse collapse" >
                               <ul class="nav navbar-nav">
                                  ...
                                  <li class="dropdown">
                                     <a class="dropdown-toggle" style="color:#339900;" href="www.w3school.com" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                              About Us
								  ...
								  <li class="dropdown">
                                     <a class="dropdown-toggle" href="#" style="color:#339900;" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                              Academic
											    <span class="caret"></span>
                                          </a>
                                          <ul class="dropdown-menu">
								   ...
								   <li class="dropdown">
                                     <a class="dropdown-toggle" href="#" style="color:#339900;"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                          ...
                                          <ul class="dropdown-menu">
                                             ...
                                             <li>
                                                  <a href="research_lab">Research lab</a>
                                             </li>
