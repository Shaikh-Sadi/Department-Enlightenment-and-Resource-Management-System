...
<div class="col-sm-8" >
  ...
  <div class="panel panel-default" style= "border: 3px solid #ddd; border-radius: 7px; padding: 3px;>
          ...
          <!-- Table -->
          <table class="table table-bordered" > <a href="#" class="list-group-item ">
          <img src="" alt="..." class=" img-circle">
    <h4 class="list-group-item-heading">Office staff name</h4>
    <p class="list-group-item-text"> Dept. of Computer Science and Engineering </p>
  </a>
