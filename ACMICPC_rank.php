               ...
               <div class="clearfix" style="margin-bottom:5px;"> </div> 
                    <div class="col-sm-4" >
	                     <div class="panel panel-default" style= "border: 3px solid #ddd; border-radius: 7px; padding: 3px; height:300px">
		                      ...
		                      <h4> <a href="dep-program.php"  >Academic</a></h4>
		                      <div class="clearfix" style="margin-bottom:px;"> </div>
		                      <h4> <a href="faculty_mem.php"  >People</a></h4>
		                      <div class="clearfix" style="margin-bottom:px;"> </div>
		                      <h4> <a href="faculty_mem.php"  >Research</a></h4>
		                      <div class="clearfix" style="margin-bottom:px;"> </div>
		                      <h4> <a href="faculty_mem.php"  >facilities</a></h4>
	                     </div>
	                </div>
                         ...
                         <div id="myCarousel" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner" role="listbox">
                                   <div class="item active">
	                                    <img class="brightness" src="image/DSC_0170.JPG" alt="img1">
	                                    <div class="carousel-caption">
                                             <p> asd bbh  jjk </p>
                                        </div>
                                   </div>
                                   <div class="item">
	                                    <img class="brightness" src="image/DSC_0173.JPG" alt="img2">
                                        <div class="carousel-caption">
                                        </div>
                                   </div>
	                               <div class="item">
                                        <img src="image/DSC_0156.JPG" alt="img2">
                                        <div class="carousel-caption">
                                        </div>
                                   </div>
                              </div>
